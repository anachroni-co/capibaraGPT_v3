#!/usr/bin/env python3
"""
Servidor ARM-Axion vLLM Clásico (No V1 Engine)
Optimizado para trabajar con CPU ARM y los 5 modelos
"""
...
# FORZAR USO DEL BACKEND CLÁSICO
os.environ['VLLM_USE_V1'] = '0'
os.environ['VLLM_ENABLE_V1_ENGINE'] = '0'
os.environ['VLLM_WORKER_MULTIPROC_METHOD'] = 'spawn'  # Para compatibilidad ARM

# vLLM imports - backend clásico
from vllm import LLM, SamplingParams
from vllm.engine.arg_utils import AsyncEngineArgs
from vllm.engine.async_llm_engine import AsyncLLMEngine

app = FastAPI(title="vLLM ARM-Axion Classic Server", version="1.0.0")
...
def load_model(model_id: str) -> LLM:
    """Load a model into memory - Classic backend"""
    ...
    model = LLM(
        ...
        enforce_eager=True,  # Compatible with classic backend
        # FORZAR CPU BACKEND
        device="cpu",
        # Classic backend optimizations
...
async def startup_event():
    ...
    print("="*70)
    print("  vLLM ARM-Axion Classic Backend Server")
    print("  Using Classic vLLM Backend (Not V1 Engine)")
...
async def root():
    """Root endpoint"""
    return {
        "name": "vLLM ARM-Axion Classic Server",
        "version": "1.0.0",
        "backend": "classic",
