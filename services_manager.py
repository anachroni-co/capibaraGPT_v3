...
class CapibaraServiceManager:
    ...
    def __init__(self):
        ...
        self.services = {
            'backend': {
                ...
                'startup_cmd': ['python', '-m', 'backend.main'],
                'working_dir': 'backend',
            ...
            'integrated_server': {
                ...
                'startup_cmd': ['python', 'capibara6_integrated_server.py'],
                'working_dir': 'backend',
    ...
    def start_all(self) -> Dict[str, bool]:
        ...
        results = {}
        for service_name in ['frontend', 'backend', 'integrated_server']:  # Iniciar en orden adecuado
...
def main():
    ...
    manager = CapibaraServiceManager()
