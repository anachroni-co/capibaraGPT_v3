...
\begin{table}[h]
\centering
\caption{Adapters LoRA V2. rank=16, $\alpha$=32 para todos excepto \textit{herramientas}
(rank=8, $\alpha$=8, dropout=0.05, siguiendo~\citep{salesforce2025xlam}).}
\label{tab:loras}
\begin{tabular}{lll}
\toprule
\textbf{Categoría} & \textbf{Adapters} & \textbf{Configuración} \\
\midrule
Legal por área  & penal, civil, laboral, constitucional, administrativo, mercantil & rank=16, $\alpha$=32 \\
Tarea general   & resumen, instruccion, qa, extraccion, redaccion, dialogo, razonamiento, traduccion & rank=16, $\alpha$=32 \\
Herramientas    & herramientas & rank=8, $\alpha$=8, dropout=0.05 \\
\bottomrule
\end{tabular}
\end{table}
