...
Conecta directamente con los modelos reales a través de vLLM
"""
...
class RealModelTester:
    def __init__(self):
        ...
        try:
            ...
            print("✅ Cliente VLLM conectado correctamente")
    ...
    def interactive_test_loop(self):
        ...
        print("🚀 INICIANDO INTERFAZ DE PRUEBA REAL DE MODELOS")
        print("=" * 60)
...
def main():
    print("🔧 INICIANDO INTERFAZ REAL DE PRUEBA DE MODELOS CAPIBARA6")
