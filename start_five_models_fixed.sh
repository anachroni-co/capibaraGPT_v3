#!/bin/bash
# Script para iniciar el servidor completo de 5 modelos con configuración corregida para AWQ

echo "🚀 INICIANDO SERVIDOR MULTI-MODELO CAPIBARA6 (5 MODELOS - CONFIGURACIÓN CORREGIDA)"
echo "   Modelos: Phi4, Mistral, Qwen, Gemma3, Aya Expanse"
echo ""
...
PORT=8085
CONFIG_FILE="config.five_models_fixed.json"

echo "🌐 Iniciando servidor en puerto $PORT..."
echo "   Configuración: $CONFIG_FILE"
echo "   Esta configuración está optimizada para modelos AWQ en CPU"
echo ""
...
echo ""
echo "🚀 Iniciando servidor vLLM multi-modelo (5 modelos con AWQ corregido)..."
echo "   Accede a: http://localhost:$PORT"
echo "   Para detener: Ctrl+C"
echo "   ⚠️  Este proceso puede tardar 10-15 minutos en cargar todos los modelos"
echo ""

# Iniciar el servidor con la configuración corregida
