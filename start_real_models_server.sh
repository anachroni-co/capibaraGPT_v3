#!/bin/bash
# Script definitivo para iniciar el sistema con los 5 modelos tal como están realmente instalados

echo "🚀 INICIANDO SERVIDOR CAPIBARA6 DEFINITIVO (5 MODELOS - REALIDAD)"
echo "   Configuración basada en los modelos físicos reales instalados"
echo ""
...
PORT=8084
CONFIG_FILE="config.five_real_models.json"

echo "🌐 Iniciando servidor definitivo en puerto $PORT..."
echo "   Configuración: $CONFIG_FILE"
echo "   Basada en los modelos físicos reales instalados"
echo ""
...
echo ""
echo "🚀 Iniciando servidor vLLM definitivo (5 modelos reales)..."
